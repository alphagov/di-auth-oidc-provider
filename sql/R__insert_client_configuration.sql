...
VALUES
    ('Dummy Service', 'some_client_id', 'password', '["openid", "profile", "email"]', '["code"]', '["https://di-auth-stub-relying-party-sandbox.london.cloudapps.digital/oidc/callback", "http://localhost:8081/oidc/callback", "http://di-auth-stub-relying-party-sandbox:8081/oidc/callback","https://localhost:5001/signin-oidc", "http://localhost:8082/login/oauth2/code/custom", "http://localhost:5000/callback"]', '["test@test.digital.cabinet-office.gov.uk"]'),
